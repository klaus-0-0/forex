...
app.use(
  cors({
    origin: ["https://forex-fy02.onrender.com"], // Allow frontend URL
  ...
  new GoogleStrategy(            // creating a new Google strategy, it can be new Facebook strategy too
    {
      ...
      callbackURL: "https://forex-fy02.onrender.com/auth/google/callback",
    },
...
app.post("/auth/google", async (req, res) => {
  try {
    ...
    const { data } = await axios.post("https://oauth2.googleapis.com/token", {
      ...
      redirect_uri: "https://forex-fy02.onrender.com", // Must match redirect URI from frontend
